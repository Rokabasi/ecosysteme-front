...
import useDossiers from './useDossier';
...
const Dossiers = () => {
  const { loading, error, customStyles, candidatureData } = useDossiers();
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <DataTable
              ...
              highlightOnHover
              pointerOnHover
              onRowClicked={(row) => window.location.href = `/admin/dossiers/${row.str_id}`}
            />
          </div>
        </div>
      </div>
