    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-4xl w-full mx-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-[#6a1754] mb-4">Bienvenue sur eCosystème</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Le portail de gestion des Organisations Non Gouvernementales (ONG) et Associations 
            Sans But Lucratif (ASBL) partenaires du FONAREV.
          </p>
        </div>
